...
AADHAAR_PHOTO_STORAGE_DIR = get_path("aadhaar_photo_temp_dir")
...
def _default_indian_id_python() -> Path:
    return get_path("id_venv_python")


def _default_indian_id_inference() -> Path:
    return get_path("indian_id_inference")
...
def extract_aadhaar_photo(file_path: str, application_id: str | None = None) -> dict:
    ...
    if application_id:
        output_dir = get_path("candidate_temp_dir") / application_id / "aadhaar_faces"
    else:
