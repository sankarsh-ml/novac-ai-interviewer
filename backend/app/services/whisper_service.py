...
DEFAULT_MODEL_DIR = PROJECT_ROOT / "backend" / "models" / "whisper"
...
def _get_whisper_model():
    ...
    preferred_model = os.getenv("WHISPER_MODEL", DEFAULT_MODEL_NAME).strip() or DEFAULT_MODEL_NAME
    model_dir = Path(os.getenv("WHISPER_MODEL_DIR", str(DEFAULT_MODEL_DIR)))
