...
import { startInterview, verifyFaceFrame } from "../api/interviewApi.js";
import { markCandidateVerified } from "../api/kycApi.js";
...
function FaceVerificationPage({ applicationSummary, cameraSession, onBackHome, onVerified }) {
  ...
  const handleStartInterview = async () => {
    ...
    try {
      await startInterview(applicationSummary.application_id);
    ...
    <main className="aadhaar-page">
      <section className="aadhaar-panel">
        ...
        <header className="aadhaar-header">
          ...
          <h1>Face Verification</h1>
          <p>Use the camera to verify your live face against the verified identity document.</p>
        </header>
