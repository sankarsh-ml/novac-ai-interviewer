...
import { scoreResume } from "@application/useCases/resumeUseCases.js";
import { useDependencies } from "@presentation/hooks/useDependencies.js";
import "@presentation/styles/AtsScreeningPage.css";
...
function AtsScreeningPage({ applicationSummary, onBackHome, onPassed }) {
  ...
  const runATS = async () => {
    try {
      ...
      const data = await scoreResume(resumeRepository, applicationSummary.application_id);
