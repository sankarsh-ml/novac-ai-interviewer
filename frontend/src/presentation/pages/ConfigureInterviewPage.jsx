...
import IdentityConfigSelector from "@presentation/components/interview/IdentityConfigSelector.jsx";
import InterviewTimerConfig from "@presentation/components/interview/InterviewTimerConfig.jsx";
import ManualQuestionSelector from "@presentation/components/interview/ManualQuestionSelector.jsx";
import QuestionSourceSelector from "@presentation/components/interview/QuestionSourceSelector.jsx";
import QwenDifficultySplit from "@presentation/components/interview/QwenDifficultySplit.jsx";
import {
  configureQuestions,
  createInterviewLink,
  fetchConfigureData,
...
import { getDateFromIso, getTimeFromIso } from "@application/mappers/interviewMapper.js";
import { useDependencies } from "@presentation/hooks/useDependencies.js";
import "@presentation/styles/ConfigureInterviewPage.css";
...
function ConfigureInterviewPage({ applicationId, onBack }) {
  ...
  const loadConfigureData = async () => {
    ...
    try {
      const data = await fetchConfigureData(interviewRepository, applicationId);
