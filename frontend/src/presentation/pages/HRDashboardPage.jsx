...
import { createJob, fetchJobs } from "@application/useCases/jobUseCases.js";
import { useDependencies } from "@presentation/hooks/useDependencies.js";
import "@presentation/styles/HRDashboardPage.css";
...
function HRDashboardPage({ onBack }) {
  ...
  const addJob = async () => {
    ...
    try {
      const data = await createJob(jobRepository, {
        title,
        description,
