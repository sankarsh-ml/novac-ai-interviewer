...
import { uploadBulkResumes } from "@application/useCases/resumeUseCases.js";
...
import "@presentation/styles/UploadResumePage.css";
...
function UploadResumesPage({job,onBack}) 
{
  ...
  const uploadResumes = async () => {
    ...
    try {
      const data = await uploadBulkResumes(resumeRepository, job.id, files);
